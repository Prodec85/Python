# Aplicaciones orientado a objetos que simule las ventas de una tienda
...
class Venta:
    ...
    def __str__(self):
        return f'Artículo: {self.articulo:<15} Cantidad: {self.cantidad:>10.2f} Precio: {self.precio:>10,.2f} Total: {self.total:>10,.2f}'
